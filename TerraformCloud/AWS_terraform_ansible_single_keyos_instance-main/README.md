# AWS_terraform_ansible_single_keyos_instance
...
1.3 Create a security group for the new KeyOS instance
# Terraform
2.1 Create a UNIX or Windows instance

2.2 Download and install Terraform

2.3 Create the folder for example ../awskeyos/

2.4 Copy all files from my folder /Terraform into your Terraform project (keyos.tf, var.tf)
2.4.1 Please type the information into the strings 22, 35, 36 of file "keyos.tf"
