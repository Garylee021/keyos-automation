...
keyos_config_commands:
    - set system host-name 'KeyOS-01'
    - set system login banner pre-login 'Welcome to the KeyOS on Azure'
    - set interfaces ethernet eth0 description 'OUTSIDE'
    - set interfaces ethernet eth1 description 'INSIDE'
    - set system name-server '${dns_1}'
    - set system name-server '${dns_2}'
    - set service dns forwarding name-server '${dns_1}'
    - set service dns forwarding listen-address '${keyos_01_priv_nic_ip}'
    ...
    - set interfaces vti vti1 description 'Tunnel KeyOS 02'
    - set interfaces vti vti1 ip adjust-mss '1350'
    - set protocols static route 10.2.100.11/32 interface vti1
    - set vpn ipsec authentication psk KeyOS id '${public_ip_address_01}'
    - set vpn ipsec authentication psk KeyOS id '${on_prem_public_ip_address}'
    - set vpn ipsec authentication psk KeyOS secret 'ch00s3-4-s3cur3-psk'
    - set vpn ipsec site-to-site peer KeyOS-02 authentication local-id '${public_ip_address_01}'
    - set vpn ipsec site-to-site peer KeyOS-02 authentication mode 'pre-shared-secret'
    - set vpn ipsec site-to-site peer KeyOS-02 authentication remote-id '${on_prem_public_ip_address}'
    - set vpn ipsec site-to-site peer KeyOS-02 connection-type 'none'
    - set vpn ipsec site-to-site peer KeyOS-02 description 'AZURE TUNNEL to KeyOS on NET 02'
    - set vpn ipsec site-to-site peer KeyOS-02 ike-group 'AZURE'
    - set vpn ipsec site-to-site peer KeyOS-02 ikev2-reauth 'inherit'
    - set vpn ipsec site-to-site peer KeyOS-02 local-address '${keyos_01_pub_nic_ip}'
    - set vpn ipsec site-to-site peer KeyOS-02 remote-address '${on_prem_public_ip_address}'
    - set vpn ipsec site-to-site peer KeyOS-02 vti bind 'vti1'
    - set vpn ipsec site-to-site peer KeyOS-02 vti esp-group 'AZURE'
