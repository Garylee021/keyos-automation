...
keyos_config_commands:
    - set system host-name 'KeyOS-01-on-Azure'
    ...
    - set vpn ipsec authentication psk KeyOS id 'KeyOS_01_Azure'
    - set vpn ipsec authentication psk KeyOS id 'KeyOS_On-Prem'
    - set vpn ipsec authentication psk KeyOS secret 'ch00s3-4-s3cur3-psk'
    - set vpn ipsec site-to-site peer On-Prem-KeyOS authentication local-id 'KeyOS_01_Azure'
    ...
    - set vpn ipsec site-to-site peer On-Prem-KeyOS local-address '${keyos_01_pub_nic_ip}'
    ...
    - set protocols bgp system-as '${keyos_01_bgp_as_number}'
    - set protocols bgp address-family ipv4-unicast network ${keyos_01_priv_subnet}
    ...
    - set protocols bgp neighbor ${route_server_ip_01} update-source '${keyos_01_priv_nic_ip}'
    ...
    - set protocols bgp neighbor ${route_server_ip_02} update-source '${keyos_01_priv_nic_ip}'
