...
keyos_config_commands:
    - set system host-name 'KeyOS-for-DEMO-Azure'
    ...
    - set service dns forwarding listen-address '${keyos_priv_nic_ip}'
    ...
    - set interfaces vti vti1 description 'Tunnel for KeyOS in AWS'
    ...
    - set vpn ipsec authentication psk KeyOS id 'KeyOS_Azure'
    - set vpn ipsec authentication psk KeyOS id 'KeyOS_AWS'
    - set vpn ipsec authentication psk KeyOS secret 'ch00s3-4-s3cur3-psk'
    - set vpn ipsec site-to-site peer AWS-KeyOS authentication local-id 'KeyOS_Azure'
    - set vpn ipsec site-to-site peer AWS-KeyOS authentication mode 'pre-shared-secret'
    - set vpn ipsec site-to-site peer AWS-KeyOS authentication remote-id 'KeyOS_AWS'
    - set vpn ipsec site-to-site peer AWS-KeyOS connection-type 'none'
    - set vpn ipsec site-to-site peer AWS-KeyOS description 'TUNNEL to KeyOS on AWS'
    - set vpn ipsec site-to-site peer AWS-KeyOS ike-group 'AWS'
    - set vpn ipsec site-to-site peer AWS-KeyOS ikev2-reauth 'inherit'
    - set vpn ipsec site-to-site peer AWS-KeyOS local-address '${keyos_pub_nic_ip}'
    - set vpn ipsec site-to-site peer AWS-KeyOS remote-address '${aws_public_ip}'
    - set vpn ipsec site-to-site peer AWS-KeyOS vti bind 'vti1'
    - set vpn ipsec site-to-site peer AWS-KeyOS vti esp-group 'AWS'
    - set protocols bgp system-as '${keyos_bgp_as_number}'
